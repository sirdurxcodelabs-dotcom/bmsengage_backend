...
const { uploadStartupLogo, processStartupLogoUpload } = require('../config/cloudinary');
...
router.post('/:id/logo', uploadStartupLogo.single('logo'), processStartupLogoUpload, ctrl.uploadLogo);
